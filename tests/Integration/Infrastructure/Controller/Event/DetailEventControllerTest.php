...
final class DetailEventControllerTest extends AbstractWebTestCase
{
    public function testEvent(): void
    {
        ...
        $this->assertSame('Balade et pique-nique en forêt de Chevreuse 13 September 2023 à 09h00 - 13 September 2023 à 18h00 Saint Remy les Chevreuses Lorem ipsum Cet événement est organisé par Mathieu 0 inscrits - 10 places disponibles S\'inscrire à cet événement', $crawler->filter('div')->text());
    ...
    public function testEventWithoutAuthentication(): void
    {
        ...
        $this->assertSame('Balade et pique-nique en forêt de Chevreuse', $crawler->filter('h1')->text());
        $this->assertMetaTitle('Balade et pique-nique en forêt de Chevreuse - Jeunot', $crawler);
        $this->assertSame('Balade et pique-nique en forêt de Chevreuse 13 September 2023 à 09h00 - 13 September 2023 à 18h00 Saint Remy les Chevreuses Lorem ipsum Cet événement est organisé par Mathieu 0 inscrits - 10 places disponibles Vous devez être connecté·e pour vous inscrire et recevoir les informations de rendez-vous.', $crawler->filter('div')->text());
        $this->assertSame(0, $crawler->filter('[data-testid="register-link"]')->count()); // No register link
    }
